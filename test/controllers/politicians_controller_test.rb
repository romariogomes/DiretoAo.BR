...
class PoliticiansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create politician" do
    assert_difference('Politician.count') do
      post politicians_url, params: { politician: { birthdate: @politician.birthdate, name: @politician.name, party: @politician.party, photo: @politician.photo } }
    end
  ...
  test "should update politician" do
    patch politician_url(@politician), params: { politician: { birthdate: @politician.birthdate, name: @politician.name, party: @politician.party, photo: @politician.photo } }
