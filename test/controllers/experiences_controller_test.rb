...
class ExperiencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create experience" do
    assert_difference('Experience.count') do
      post experiences_url, params: { experience: { end_year: @experience.end_year, init_year: @experience.init_year, title: @experience.title } }
    end
  ...
  test "should update experience" do
    patch experience_url(@experience), params: { experience: { end_year: @experience.end_year, init_year: @experience.init_year, title: @experience.title } }
